...
fields_names = {
    'birth_certificate': (("Фамилия", 'last_name', 0, 'person'),
                          ...
                          ("Тип документа", 'document_id', 'Combobox', 'person'),
    ...
    'addresses': (("Выберите тип адреса*", 'address_type_id', 'Combobox', 'address'),
                  ("Индекс", 'zipcode', 0, 'address'),
                  ("Тип субъекта", 'region_type_id', 'Combobox', 'address'),
                  ("Субъект(республика, край, область)", 0, 'address'),
                  ("Район области", 'district', 0, 'address'),
                  ("Тип города", 'town_type_id', 'Combobox', 'address'),
                  ("Город", 'town', 0, 'address'),
                  ("Тип населенного пункта", 'locality_type_id', 'Combobox', 'address'),
                  ("Населенный пункт", 'locality', 0, 'address'),
                  ('Тип улицы', 'street_type_id', 'Combobox', 'address'),
                  ...
                  ("Район Санкт-Петербурга", 'town_district', 'Combobox', 'address')),
    'agreement': (("ФИО родителя в договоре", 'person_id', 'Combobox', 'movement'),
                  ("Группа план", 'team_id', 'Combobox', 'movement'),
                  ...
                  ("Дата договора", 'contarct_date', 'DateEntry', 'movement'),
